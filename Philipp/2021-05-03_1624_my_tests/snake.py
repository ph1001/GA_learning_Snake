...
# For testing: fix the food's position
fixed_food_x = 50
fixed_food_y = 50
...
def controlled_run(individual, ind_number, evolution_step, games_to_play, verbose, moves_till_stuck):
    ...
    def gameLoop(score_list, age_list, move_score_sum_list, verbose, moves_till_stuck):
        ...
        # For testing: place the first food item at a fixed spot
        #foodx = fixed_food_x
        #foody = fixed_food_y
        ...
        while not game_over:
                    ...
                    for event in pygame.event.get():
                        if event.type == pygame.KEYDOWN:
                            ...
                            if event.key == pygame.K_c:
                                score_list, age_list, move_score_sum_list = gameLoop(score_list, age_list, move_score_sum_list, verbose, moves_till_stuck)
            ...
            # From the second move onwards      
                ...
                # Define which direction is a forbidden move
                if direction == 'up':
                ...
                # Pass it to control()
                game_action, move_score = individual.control(game_state)

                # Add this move_score to move_score_sum
                move_score_sum += move_score
            ...
            # If the command is for the snake to turn around 180°, the game is over
            ...
            if x1 == foodx and y1 == foody:
                ...
                # For testing: Place food in a fixed spot
                #foodx = fixed_food_x
                #foody = fixed_food_y
        ...
        move_score_sum_list.append(move_score_sum)

        # Return the current list of fitnesses
        return score_list, age_list, move_score_sum_list
    
    # Initialise lists for storing the scores, ages and move_score_sums resulting from the games_to_play games for this individual in this evolution step
    score_list, age_list, move_score_sum_list = [], [], []
    ...
    avg_move_score_sum = sum(move_score_sum_list) / games_to_play
    if verbose:
    ...
    return score, age, avg_move_score_sum