# -*- coding: utf-8 -*-
"""
Created on Fri May 14 16:25:22 2021
...
def create_randomfunct(len_functions, terminals, operators, max_depth, impose_depth = False):
    ...
    if not impose_depth:
        ...
        max_depth = random.choice(list(range(max_depth)))
    
    for _ in range(max_depth + 1):
        
        funct = random.sample(list(range(len_functions)), 2)
