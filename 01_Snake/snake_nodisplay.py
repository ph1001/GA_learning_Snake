        ...
        while not game_over:
            ...
            # From the second move onwards      
                ...
                if game_action == 0: #continue same direction
                    ...
                    if y1_old == - snake_block_nodisplay: #recognize if it's moving up vertically
                        x1_change =   snake_block_nodisplay
                        y1_change = 0
                    elif y1_old == snake_block_nodisplay: #recognize if it's moving down vertically
                        x1_change =  - snake_block_nodisplay
                        y1_change = 0
                    elif x1_old == - snake_block_nodisplay: #recognize if it's moving left horizontally
                        x1_change =  0
                        y1_change = - snake_block_nodisplay
